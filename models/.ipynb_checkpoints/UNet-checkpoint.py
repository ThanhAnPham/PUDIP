...
class UNet(nn.Module):
    ...
    def __init__(self, num_input_channels=3, num_output_channels=3, 
                       feature_scale=1, more_layers=0, concat_x=False,
                       upsample_mode='deconv', pad='zero', norm_layer=nn.BatchNorm2d, need_sigmoid=False, need_softmax=True, need_bias=True):
...
class unetUp(nn.Module):
    def __init__(self, out_size, upsample_mode, need_bias, pad, same_num_filt=True):
